...
use Dearvn\FilamentAccessControl\Database\Factories\FilamentUserFactory;
use Dearvn\FilamentAccessControl\Enumerators\RoleName;
...
/**
 * Dearvn\FilamentAccessControl\Models\FilamentUser.
 *
 * @property int $id
